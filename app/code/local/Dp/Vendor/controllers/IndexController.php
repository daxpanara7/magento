...
class Dp_Vendor_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function _sendmail($model, $content)
    {
        ...
        $config = array(
            ...
            'port' => 587,
            'auth' => 'login',
            'username' => 'daxpanara7@gmail.com', // Replace with your Gmail email address
            'password' => 'zvpjgbvpcdzwimfh', // Replace with your Gmail password or app password
        );
        ...
        $mail->setfrom('daxpanara7@gmail.com', 'DAX PANARA'); // Replace with your Gmail email address and name
