...
class Dax_Eavmgmt_Block_Adminhtml_Eavmgmt_Exportoption extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
     protected function _prepareColumns()
    {
        $this->addColumn('index', array(
            ...
            'index'  => 'entity_id',
            'renderer'=> 'Dax_Eavmgmt_Block_Adminhtml_eavmgmt_Csv_Number'
        ));
        ...
        $this->addColumn('attribute_id', array(
            ...
            'sortable'=>true,
            'index'=>'attribute_id',
            'renderer'=> 'Dax_Eavmgmt_Block_Adminhtml_eavmgmt_Csv_entityType'
        ));
        ...
        $this->addColumn('option_id', array(
         ...
         $this->addColumn('value', array(
            ...
            'sortable'=>true,
            'index'=>'value',
            'renderer'=> 'Dax_Eavmgmt_Block_Adminhtml_eavmgmt_Csv_entityOption'
        ));
