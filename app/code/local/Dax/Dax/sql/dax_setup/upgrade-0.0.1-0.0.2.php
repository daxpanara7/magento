...
$table = $installer->getConnection()
		->newTable($installer->getTable('dax/eav_attribute'))
    ...
    ->addIndex($installer->getIdxName('dax/eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('dax/eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('dax/eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
        'attribute_id', $installer->getTable('eav/attribute'), 'attribute_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Dax EAV Attribute Table');

    $query = "ALTER TABLE `dax_varchar` ADD UNIQUE( `attribute_id`, `store_id`, `entity_id`)";
...
$setup->addAttribute(Dax_Dax_Model_Resource_Dax::ENTITY, 'firstname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'firstname',
    ...
    'global'                     => Dax_Dax_Model_Resource_Eav_Attribute::SCOPE_STORE,

));

$setup->addAttribute(Dax_Dax_Model_Resource_Dax::ENTITY, 'lastname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'lastname',
...
$setup->addAttribute(Dax_Dax_Model_Resource_Dax::ENTITY, 'email', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'email',
...
$setup->addAttribute(Dax_Dax_Model_Resource_Dax::ENTITY, 'phoneNo', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'phoneNo',
