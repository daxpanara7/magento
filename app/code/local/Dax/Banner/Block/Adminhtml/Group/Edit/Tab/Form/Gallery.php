<?php
class Dax_Banner_Block_Adminhtml_Group_Edit_Tab_Form_Gallery extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getContentHtml()
    {
        ...
        $content = Mage::getSingleton('core/layout')
            ->createBlock('banner/adminhtml_group_edit_form_gallery_content');
