<?php
ini_set('memory_limit','512M');//('name of setting', 'value')
class Ccc_practice_Adminhtml_CsvController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _loadCategoryFile()
    {
        ...
        if ($handler) {
            ...
            while ($row = fgetcsv($handler, 4096, ",", "\"")) //fgetcsv(file, length, separator, enclosure) 
            {
